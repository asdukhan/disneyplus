      ...
      />
            ...
            inset-x-4 md:inset-x-12 space-y-6 z-50'>
                ...
                md:space-x-5'>
                    ...
                    text-black flex items-center justify-center py-2.5
              ...
              <div className="rounded-full border-2 border-white flex items-center justify-center w-11 h-11 cursor-pointer bg-black/60">
                <Image src="/images/group-icon.svg" layout='fill'   alt="image"/>
              </div>
...
export async function getServerSideProps(context) {
    ...
    const request = await fetch(`https://api.theShowdb.org/3/Show/${id}?api_key=${process.env.API_KEY}&language=en-US&append_to_response=videos`)
